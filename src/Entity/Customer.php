...
class Customer
{
     ...
     * @Assert\Length(min="4", minMessage="Le prénom ne peut pas faire moins de 4 caractères", max="255", maxMessage="Le prénom doit faire moins de 255 caractères")
     */
    private $firstName;
     ...
     * @Assert\Length(min="4", minMessage="Le nom ne peut pas faire moins de 4 caractères", max="255", maxMessage="Le nom doit faire moins de 255 caractères")
     */
    private $lastName;
     ...
     * @return float
     */
    public function getUnpayedAmount(): float
    {
        return array_reduce($this->invoices->toArray(), function ($total, $invoice) {
